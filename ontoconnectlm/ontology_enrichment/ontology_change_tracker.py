...
class OntologyChangeTracker:
    ...
    """
    Encode changes between ontology versions 
    Args: older ontology version and newer one
    Features:
    - Load the ontology and graph content
    - Compare entities, relations and individuals
    - Report the changes 
    Returns: display entity changes and triple changes 
    ...
    def report_changes(self):      
        ...
        return triples_diff, entities_diff
